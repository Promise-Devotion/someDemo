 /**
 * the myvideo for plugin editor
 * created by jnvfgfs@gmail.com 18/07/2016
 *  
 */

(function(JH5MF) {
    JH5MF.Editor.register('myvideo',
        '', /*'l10n!/layouts/views/plugins/myvideo-editor.tmpl',**/
        function(rootElement, jh5mf, baseLayout) {
            ...
            // The codes here is myvideo only. 
            ...
            JH5MF.Editor.TrackEventEditor.extend(_this, jh5mf, _rootElement, {
                open: function(parentElement, trackEvent) {
                    ...
                    trackEvent.listen('hello.myvideo', function(e) {
                        // demo only here.

...
(function(JH5MF) {
    JH5MF.Editor.register("lineCharts",
        "", /*"l10n!/layouts/views/plugins/lineCharts-editor.tmpl",**/
        function(rootElement, jh5mf, baseLayout) {
            ...
            // The codes here is lineCharts only. 
            ...
            JH5MF.Editor.TrackEventEditor.extend(_this, jh5mf, _rootElement, {
                open: function(parentElement, trackEvent) {
                    ...
                    trackEvent.listen("dataChange.lineCharts", onAreaCountChange);
                    trackEvent.listen("trackeventupdated", onTrackEventUpdated);
                    // to setup property UI.
                    setup(trackEvent);
                },
                close: function() {
                    _trackEvent.unlisten("dataChange.lineCharts", onAreaCountChange);

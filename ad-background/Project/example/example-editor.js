/**
 * the example for plugin editor
 * created by john.k.ch2012@gmail.com, 11/06/2015
 *
 **/

(function(JH5MF) {
    JH5MF.Editor.register("example",
        ...
        function(rootElement, jh5mf, baseLayout) {
            ...
            JH5MF.Editor.TrackEventEditor.extend(_this, jh5mf, _rootElement, {
                open: function(parentElement, trackEvent) {
                    ...
                    _trackEvent.listen("colorchanged.example", function(e) {
